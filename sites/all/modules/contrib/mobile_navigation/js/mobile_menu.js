  ...
  var mobile_menu = function(elem, options) {
    ...
    this.methods = {
      ...
      cloneMenu : function() {
        ...
        // Cloning
        $('#mobile-menu-inner').append("<div id='mobile-menu' class='" + classes + "'>" + $(_this.target).html() + "</div>");
      ...
      slideMenuBuild : function() {
        ...
        if (!$("#mobile-menu").length) {
          ...
          function buildNewSub(sub) {
            ...
            console.log('id = '+id); console.log(sub);
            console.log('mm_w = '+mm_w);
            var ul = $($('<div></div>').html($(sub).clone())).html();

            $("#slide-menu-clip").append("<ul id='" + id + "' class='mobile-menu mobile-menu-slide'>" + ul + "</ul>");
            $("#" + id + " > li > .sub-menu-wrapper > .item-list > ul, #" + id + " > li > .sub-menu-wrapper > .menu").show();
            $("#" + id + " > li > *").first().addClass("return-link");
            $("#" + id + " > li > .sub-menu-wrapper > .item-list > ul, #" + id + " > li > .sub-menu-wrapper > .menu").css({
              padding : 0
            });
        ...
        if ($(button).hasClass("active")) {/* If it's openned */
          ...
          switch (_this.settings.showEffect) {
            ...
            case "drawer_right":
              ...
              $(_this.settings.mainPageSelector).animate({
                ...
                let $scrollTop = Math.abs(parseInt($("#page-wrapper").css('top')));
                $("#page-wrapper").css({'top': '0', 'position':'relative'});
          ...
          switch (_this.settings.showEffect) {
            ...
            case "drawer_right":
							...
							$("#page-wrapper").css({'top': "-"+($pos)+'px', 'position':'fixed'});
